<template>
    ...
    <a-form-item label="Address(country,city,subcity,werda,house number)" >
    ...
    <a-form-item label="BirthDate">
      <a-input type="date"  v-model:value="formData.birthDate"/>
    </a-form-item>

    <a-form-item label="Gender"  >
      <!-- <div v-if="errors.type" class="text-custom_red-100">{{ errors.gender }}</div> -->
      <a-select v-model:value="formData.gender" placeholder="Select a Type">
  ...
  const handleSubmit = () => {
    ...
    accountService.updateAccount(formData.value).then(res=>{

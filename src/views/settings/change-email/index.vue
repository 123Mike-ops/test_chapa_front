<template>
    <div class="container flex  bg-white flex-col" ref="scrollContainer">
     ...
     <div class="w-full flex justify-between items-center h-16  lg:px-5 py-2 shadow-md mb-4 ">
         <div class="text-2xl hidden md:block">Change Email</div>
     </div>
 ...
 const handleSubmit = () => {
   ...
   accountService.changeEmail(formData.value).then(res=>{
    message.success('the email has been updated successfully');
   }).catch(err=>{
